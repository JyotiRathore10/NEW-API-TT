...
// GET Timesheet Entries By Employee with Lazy Loading (Pagination)
exports.getTimesheetEntriesByEmployee = async (req, res) => {
    console.log('🔵 getTimesheetEntriesByEmployee called');
    console.log('📦 Request body:', req.body);

    try {
        const { EmployeeID, EmployeeIDs, page = 1, limit = 10 } = req.body;
        console.log('📍 EmployeeID:', EmployeeID, 'EmployeeIDs:', EmployeeIDs);
        ...
        countResult = await request.query(countQuery);
        ...
        console.log(`✅ Entries loaded this time: ${result.recordset.length}`);
        ...
        console.error('❌ Error in getTimesheetEntriesByEmployee:', err.message);
